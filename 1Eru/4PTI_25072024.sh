#!/bin/bash
#SBATCH --job-name=4PTI_25072024
#SBATCH --output=4PTI_25072024.out    # Standard output
...
COPYLIST=$(ls | grep -v 4PTI_25072024.out | awk '{printf $1" "}')
...
echo -e "\n copy all except 4PTI_25072024.out file to ${SCRATCHDIR}! \n"
...
cleanup_copy (){
                ...
                then
                         ...
                         echo "copying files to /work/cingoez/4PTI_25072024/"
                         ...
                         cp -p -v -r ${SCRATCHDIR}/* /work/cingoez/4PTI_25072024/
