#!/bin/bash
#SBATCH --job-name=:Q_03072024
#SBATCH --output=:Q_03072024.out    # Standard output
...
COPYLIST=$(ls | grep -v :Q_03072024.out | awk '{printf $1" "}')
...
echo -e "\n copy all except :Q_03072024.out file to ${SCRATCHDIR}! \n"
...
cleanup_copy (){
                ...
                then
                         ...
                         echo "copying files to /work/cingoez/:Q_03072024/"
                         ...
                         cp -p -v -r ${SCRATCHDIR}/* /work/cingoez/:Q_03072024/
