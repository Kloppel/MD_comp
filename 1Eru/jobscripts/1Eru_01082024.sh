#!/bin/bash
#SBATCH --job-name=1Eru_01082024
#SBATCH --output=1Eru_01082024.out    # Standard output
...
COPYLIST=$(ls | grep -v 1Eru_01082024.out | awk '{printf $1" "}')
...
echo -e "\n copy all except 1Eru_01082024.out file to ${SCRATCHDIR}! \n"
...
cleanup_copy (){
                ...
                then
                         ...
                         echo "copying files to /work/cingoez/1Eru_01082024/"
                         ...
                         cp -p -v -r ${SCRATCHDIR}/* /work/cingoez/1Eru_01082024/
...
/projects/biomodeling/charmm-lite/c46b1/ser/bin/charmm cnt=1 < step5_production.inp > step5_production.logfile
