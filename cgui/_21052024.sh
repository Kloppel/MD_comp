...
#SBATCH --job-name=_21052024

#SBATCH --output=_21052024.out    # Standard output
...
#SBATCH --time=while [ ! -s ${JOBWORKDIR}/${JOBFILE}.inp ]; do
...
#SBATCH --mail-user=s.leipnitz@tu-berlin.de
...
COPYLIST=$(ls | grep -v _21052024.out | awk '{printf $1" "}')
...
echo -e "\n copy all except _21052024.out file to ${SCRATCHDIR}! \n"
...
cleanup_copy (){
                ...
                then
                         ...
                         echo "copying files to /work/cingoez/_21052024/"
                         ...
                         cp -p -v -r ${SCRATCHDIR}/* /work/cingoez/_21052024/
...
/projects/biomodeling/charmm-lite/c46b1/ser/bin/charmm .inp > .logfile
