#!/bin/bash
#SBATCH --job-name=sahin_21052024
#SBATCH --output=sahin_21052024.out    # Standard output
...
COPYLIST=$(ls | grep -v sahin_21052024.out | awk '{printf $1" "}')
...
echo -e "\n copy all except sahin_21052024.out file to ${SCRATCHDIR}! \n"
...
cleanup_copy (){
                ...
                then
                         ...
                         echo "copying files to /work/cingoez/sahin_21052024/"
                         ...
                         cp -p -v -r ${SCRATCHDIR}/* /work/cingoez/sahin_21052024/
...
/projects/biomodeling/charmm-lite/c46b1/ser/bin/charmm < step4_equilibration.inp > step4_equilibration.logfile
