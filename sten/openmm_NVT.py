...
equilibrationSteps = 1100000
dcdReporter = DCDReporter('output/eq_sten.dcd', 100)
dataReporter = StateDataReporter('output/sten_eq.txt', 100, totalSteps=equilibrationSteps,
                                 step=True, speed=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, volume=True, temperature=True, separator='\t')
checkpointReporter = CheckpointReporter('output/sten_eq.chk', 100)
...
checkpoint_file = 'output/sten_eq.chk'
...
with open('sten_eq.pdb', 'w') as output:
