...
dcdReporter = DCDReporter('../outfile/4pti_NVT.dcd', 100)
dataReporter = StateDataReporter('../outfile/4pti_NVT.txt', 100, totalSteps=equilibrationSteps,
                                 step=True, speed=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, volume=True, temperature=True, separator='\t')
checkpointReporter = CheckpointReporter('../outfile/4pti_NVT.chk', 100)
...
with open('../struct/4pti_NVT.pdb', 'w') as output:
