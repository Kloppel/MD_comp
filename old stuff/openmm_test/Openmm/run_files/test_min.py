...
dcdReporter = DCDReporter('../outfile/4pti_min.dcd', 100)
dataReporter = StateDataReporter('../outfile/4pti_min.txt', 100, totalSteps=equilibrationSteps,
                                 step=True, speed=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, volume=True, temperature=True, separator='\t')
checkpointReporter = CheckpointReporter('../outfile/4pti_min.chk', 100)
...
checkpoint_file = '../outfile/4pti_min.chk'
...
with open('../struct/4pti_min.pdb', 'w') as output:
