...
dcdReporter = DCDReporter('../outfile/4pti.dcd', 100)
dataReporter = StateDataReporter('../outfile/4pti.txt', 100, totalSteps=equilibrationSteps,
                                 step=True, speed=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, volume=True, temperature=True, separator='\t')
checkpointReporter = CheckpointReporter('../outfile/4pti_crd.chk', 100)
...
checkpoint_file = '../outfile/4pti.chk'
...
with open('../struct/4pti.pdb', 'w') as output:
