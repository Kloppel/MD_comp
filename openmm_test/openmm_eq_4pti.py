...
dcdReporter = DCDReporter('../outfile/4pti_eq_test.dcd', 100)
dataReporter = StateDataReporter('../outfile/4pti_eq_test.txt', 100, totalSteps=equilibrationSteps,
                                 step=True, speed=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, volume=True, temperature=True, separator='\t')
checkpointReporter = CheckpointReporter('../outfile/4pti_eq_test.chk', 100)
...
checkpoint_file = '../outfile/4pti_eq_test.chk'
...
with open('../struct/eq_4pti_test.pdb', 'w') as output:
