...
dataReporter = StateDataReporter('log2.txt', 10000, totalSteps=steps,
    step=True, speed=True, progress=True, potentialEnergy=True, temperature=True, kineticEnergy=True, volume=True, totalEnergy=True, pressure=True, separator='\t')
checkpointReporter = CheckpointReporter('checkpoint2.chk', 10000)
