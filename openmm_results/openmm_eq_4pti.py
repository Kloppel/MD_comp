...
dcdReporter = DCDReporter('4pti.dcd', 1000)
dataReporter = StateDataReporter('log.txt', 1000, totalSteps=steps,
    step=True, speed=True, progress=True, potentialEnergy=True, temperature=True, kineticEnergy=True, totalEnergy=True, separator='\t')
